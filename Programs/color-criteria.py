...
def validate_data(df):
    ...
    required_cols = ["W1mag", "W2mag", "rImag", "Hamag", "gmag", "Hmag", "Jmag"]
...
def main():
    ...
    try:
        ...
        combine_logic = {
            'and': criterion1 & criterion2 & criterion3 & criterion4 & criterion5 & criterion6,
            'or': criterion1 | criterion2 | criterion3 | criterion4 | criterion5 | criterion6
        }
        ...
        output_csv = f"{output_base}-candidates.csv"
        ...
        if args.plot:
            output_pdf = f"{output_base}-diagrams.pdf"
